...
public static class ServiceCollectionExtensions
{
		...
		Action<IHttpClientBuilder> configureGrpcClient = null)
	{
		...
		serviceCollection.AddSingleton<ISignMessage<AtomicLockRequestV2>, AtomicLockRequestV2MessageSigner>();
		serviceCollection.AddSingleton<ISignMessage<AtomicTransferRequestV1>, AtomicTransferRequestV1MessageSigner>();
