...
internal interface IIdCryptPublisher
{
	...
	Task<SendResult> SendIdCryptInvitationConfirmationAsync(IdCryptInvitationConfirmationV1 message, string bankPartnerDid, CancellationToken cancellationToken);
}
